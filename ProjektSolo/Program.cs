...
namespace ProjektSolo
{
    internal class Program
    {
        ...
        public static List<Plyta.UlubionyUtworT> listaUlubUtworow = new List<Plyta.UlubionyUtworT>();
        public static List<Plyta.UlubionyWykonawcaEver> listaUlubWyk = new List<Plyta.UlubionyWykonawcaEver>();
        ...
        static void DodajUlubWyk()
        {
            ...
            Plyta.UlubionyWykonawcaEver nowyUlubWyk = new Plyta.UlubionyWykonawcaEver(imie, nazwisko, gat);
        ...
        static void DodajUlubUtwor()
        {
            ...
            Plyta.UlubionyUtworT nowyUlubU = new Plyta.UlubionyUtworT(t, w, g);
